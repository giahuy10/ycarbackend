 ...
 * @since  1.6
 */
class UberTabletransaction extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'UberTabletransaction', array('typeAlias' => 'com_uber.transaction'));
		parent::__construct('#__uber_transaction', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_uber.transaction.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_uber/access.xml',
				"/access/section[@name='transaction']/"
			);
			$default_actions = JAccess::getAssetRules('com_uber.transaction.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_uber.transaction.' . (int) $this->$k;
	}
