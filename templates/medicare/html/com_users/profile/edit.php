		...
		<fieldset>
			...
			<div class="control-group">
						<div class="control-label">
							<label id="jform_password-lbl" for="jform_password" class="hasPopover" title="Mật khẩu" data-content="Đặt mật khẩu cho bạn - Nhập ít nhất là 4 ký tự" aria-invalid="false">
	Mật khẩu cũ:</label>
														
													</div>
						<div class="controls">
															 <input type="password" style="display:none">
														<input type="password" name="jform[password]" id="jform_password" value="" autocomplete="off" class="validate-password" size="30" maxlength="99" aria-invalid="false" required>						</div>
					</div>
			...
			<?php // If the field is hidden, just display the input. ?>
				...
				<?php else : ?>
					<div class="control-group <?php if ($field->name != "jform[password2]" && $field->name != "jform[password1]" ) echo "hidden"?>">
						<div class="control-label">
